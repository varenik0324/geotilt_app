...
# ---------- Вкладка 3: Свайные испытания (временно отключена) ----------
with tab3:
    st.info("🧪 Вкладка «Свайные испытания» временно отключена для отладки. Функционал будет восстановлен в ближайшее время.")
